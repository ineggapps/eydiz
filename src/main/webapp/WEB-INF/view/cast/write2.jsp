         ...
         <div class="cast">
          <h3><span class="cast_s"> 캐스트 </span> </h3>
           ...
           <tr class="boxrow3" align="left"> 
               ...
               <td class="text2"> 
                 <textarea class="aaa" name="castContent" rows="12" style="width: 95%;" id="content2">${dto.castContent}</textarea>
               </td>
           </tr>
           </table>
...
function pasteHTML() {
	...
	oEditors.getById["content2"].exec("PASTE_HTML", [sHTML]);
}

function showHTML() {
	var sHTML = oEditors.getById["content2"].getIR();
	alert(sHTML);
}
	
function submitContents(elClickedObj) {
	oEditors.getById["content2"].exec("UPDATE_CONTENTS_FIELD", []);	// 에디터의 내용이 textarea에 적용됩니다.
...
function setDefaultFont() {
	var sDefaultFont = '돋움';
	var nFontSize = 24;
	oEditors.getById["content2"].setDefaultFont(sDefaultFont, nFontSize);
}
</script>
